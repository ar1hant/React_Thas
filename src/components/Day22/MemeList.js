  ...
  return(
    <div>
    {
        templates.map((template) => (
          <div className="MemeList_template" key={template.id} onClick={() => {
            setMeme(template)
          }}>
            <div className="MemeList_img" style={{ backgroundImage: `url(${template.url})` }}></div>
          </div>
        ))
    }
    </div>
